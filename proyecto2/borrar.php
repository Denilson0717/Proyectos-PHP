<?php
    ...
    if(isset($_POST['borrarRegistro'])){
        //validacon
        $query = "DELETE FROM usuario WHERE id = '$idResgistro'";
        ...
        <div class="row caja">
            ...
            <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="apellido" placeholder="Ingresa los apellidos" value="<?php echo $fila['apellido']; ?>" readonly>                    
                </div>
